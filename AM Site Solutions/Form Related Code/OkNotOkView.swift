...
class OkNotOkView: UIView {
    ...
    private func setupLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            okButton.widthAnchor.constraint(equalToConstant: 100),  // Extended width for OK button

            // Not OK Button Constraints
            notOkButton.topAnchor.constraint(equalTo: questionLabel.bottomAnchor, constant: 12),
            notOkButton.leadingAnchor.constraint(equalTo: okButton.trailingAnchor, constant: 24),  // Adjusted leading
            notOkButton.widthAnchor.constraint(equalToConstant: 110),  // Extended width

            // N/A Button Constraints
            naButton.topAnchor.constraint(equalTo: questionLabel.bottomAnchor, constant: 12),
            naButton.leadingAnchor.constraint(equalTo: notOkButton.trailingAnchor, constant: 24),  // Adjusted leading
            naButton.widthAnchor.constraint(equalToConstant: 80),  // Adjusted width
...
//        let label = UILabel()
//        label.numberOfLines = 0
//        label.font = UIFont.systemFont(ofSize: 18) // Slightly smaller font
...
//            okButton.widthAnchor.constraint(equalToConstant: 100),  // Extended width
//
//            notOkButton.topAnchor.constraint(equalTo: questionLabel.bottomAnchor, constant: 12),
//            notOkButton.leadingAnchor.constraint(equalTo: okButton.trailingAnchor, constant: 24),  // Adjusted leading
//            notOkButton.widthAnchor.constraint(equalToConstant: 110),  // Extended width
...
//            commentTextField.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -16),
//            commentTextField.heightAnchor.constraint(equalToConstant: 40)
//        ])
//    }
//
